export const translations = {
  ...
  ar: {
    ...
    hero: {
      title: "شركة إعمار ليبيا للأبواب والنوافذ الألومنيوم",
    ...
    aboutPreview: {
      title: "عن شركة إعمار ليبيا",
      text: "إعمار ليبيا هي شركة رائدة في تصنيع الأبواب والنوافذ والهياكل الزخرفية من الألومنيوم عالي الجودة. بفضل التزامنا بالحرفية والأسعار التنافسية، نخدم قطاع البناء في ليبيا منذ عام 2007.",
    ...
    about: {
      pageTitle: "من نحن",
      pageSubtitle: "تعرف على تاريخ ورسالة شركة إعمار ليبيا",
      historyTitle: "تاريخنا",
      historyText: "تأسست شركة إعمار ليبيا في عام 2007 برؤية لتصبح الشركة الرائدة في تصنيع الألومنيوم في ليبيا. بعد سنوات من التفاني في الجودة ورضا العملاء، حصلت الشركة على رخصتها الرسمية في عام 2012.",
      ...
      licenseText: "تحمل شركة إعمار ليبيا ترخيص تصنيع رسمي صادر في عام 2012 من الجهات الليبية المختصة، مما يؤكد شرعية الشركة وامتثالها للمعايير الوطنية.",
    },
    services: {
      pageTitle: "خدماتنا",
    ...
    contact: {
      pageTitle: "اتصل بنا",
      pageSubtitle: "تواصل مع شركة إعمار ليبيا",
      phone: "الهاتف / واتساب",
    ...
    footer: {
      description: "شركة رائدة في تصنيع أبواب ونوافذ وهياكل ألومنيوم عالية الجودة في ليبيا. نقدم الجودة منذ 2007.",
